...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/ConfigExport/CloudSync': RouteRecordInfo<'/ConfigExport/CloudSync', '/ConfigExport/CloudSync', Record<never, never>, Record<never, never>>,
    '/ConfigExport/LocalExport': RouteRecordInfo<'/ConfigExport/LocalExport', '/ConfigExport/LocalExport', Record<never, never>, Record<never, never>>,
    ...
    '/TokenImport/cloudRestore': RouteRecordInfo<'/TokenImport/cloudRestore', '/TokenImport/cloudRestore', Record<never, never>, Record<never, never>>,
    '/TokenImport/localRestore': RouteRecordInfo<'/TokenImport/localRestore', '/TokenImport/localRestore', Record<never, never>, Record<never, never>>,
